				...
				<Container>
					...
					<section className="knowhow">
						...
						<p>
							...
							Thanks to my experience as
							<span>dev</span> and <span>creative</span>, i can understand both creation sides of a
							digital product always keeping an eye on <span>business</span> and <span>costs</span>{' '}
							specifics. In the small projects, i can <span>lead</span> all the entire process without
							losing myself, with the big ones i can <span>manage</span> the project throught{' '}
							<span>AGILE</span> or <span>LEAN</span>
					...
					<section className="toolkit">
						...
						<div className="content">
							<p>
								...
								used tools like <span>Adobe XD</span>
								or <span>Framer</span> to show some <span>POC</span> to the customers. After this, as a
								supporter of <span>JAMStack</span> architecture, i start with the tech side figuring out
								which
								<span>javascript</span> library or framework is better to achieve the specific goal. I
								like the flexibility of <span>React</span> and its whole ecosystem,{' '}
								<span>styled components</span> and the <span>stylesheet</span> declinations (obviously{' '}
								<span>SCSS</span> remain the king), all connected togheter by <span>headless API</span>{' '}
								with content managed through an
